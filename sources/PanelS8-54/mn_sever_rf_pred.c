...
//const char mask_kn[6] = {0xc9,0xc9,0xc9,0x99,0xbf,0x89};
 ...
 if (pr_stab==1)
    {
      switch(ii)   //номер сигнала SL0,SL1,SL2,SL3,SL4,SL5
			{
              case 0:  //SL0
                //Кнопки K1, МЕНЮ, Сброс B/дел.,Сброс смещ. :
				if (!(tek3_state_rb & (1 << 0)))  { //K1
                                                    buf_per=0x81;  //№1-наж.
                                                    do
                                                     tek3_state_rb = input_a(); 
                  ...
                  if (!(tek3_state_rb & (1 << 3)))  { //Сброс B/дел.
                                                     buf_per=0x9c;  //№28-наж.
                                                    do
                                                     tek3_state_rb = input_a(); 
                  ...
                  if (!(tek3_state_rb & (1 << 7)))  { //Сброс смещ.
                                                      buf_per=0x9d;  //№29-наж.
                                                    do
                                                     tek3_state_rb = input_a(); 
                  ...
                  if (!(tek3_state_rb & (1 << 6))) {  // МЕНЮ
                                                      buf_per=0x8d;  //№13-наж.
                                                    do
                                                     tek3_state_rb = input_a(); 
                                                    while (!(tek3_state_rb & (1 << 6)));
                                                    //отжатие произошло
                                                    while (buf_per!=0) {}
                                                     buf_per=0x0d;  //№13-отж.
                                                    break; 
          ...
          //     {                 
              ...
              case 1:    //SL1
               //Кнопки K2, 1 , Сброс B/дел.,Сброс смещ.:
				if (!(tek3_state_rb & (1 << 0)))  //Кнопки K2
                                                  { 
                                                    buf_per=0x83;  //№3-наж.
                                                    do
                                                     tek3_state_rb = input_a(); 
                  ...
                  if (!(tek3_state_rb & (1 << 6))) //Кнопки Men "1":
                                                  {
                                                     buf_per=0x8e;  //№14-наж.
                                                    do
                                                     tek3_state_rb = input_a(); 
              ...
              case 2: //SL2
               //Кнопки Raz, 2,Сброс Вр/дел,Сброс Задержка :
				if (!(tek3_state_rb & (1 << 0)))  //Кнопки Raz
                                                   {
                                                     buf_per=0x85;  //№5-наж.
                                                    do
                                                     tek3_state_rb = input_a(); 
                  ...
                  if (!(tek3_state_rb & (1 << 3)))  //Сброс Вр/дел
                                                   {
                                                     buf_per=0xa0;  //№32-наж.
                                                    do
                                                     tek3_state_rb = input_a(); 
                  ...
                  if (!(tek3_state_rb & (1 << 7)))   //Сброс Задержка
                                                   {
                                                     buf_per=0xa1;  //№33-наж.
                                                    do
                                                     tek3_state_rb = input_a(); 
                  ...
                  if (!(tek3_state_rb & (1 << 6))) //Кнопки Men "2":
                                                  {
                                                    buf_per=0x8f;  //№15-наж.
                                                    do
                                                     tek3_state_rb = input_a(); 
              ...
              case 3:  //SL3
               ...
               //Кнопки Sinch, Pusk, 3 , Сброс Уровня:
				if (!(tek3_state_rb & (1 << 0))) //Кнопкa Sinch
                                                 {
                                                    buf_per=0x87;  //№7-наж.
                                                    do
                                                     tek3_state_rb = input_a(); 
                ...
                if (!(tek3_state_rb & (1 << 3)))     //Сброс Уровня:
                                                  {
                                                    buf_per=0xa2;  //№34-наж.
                                                    do
                                                     tek3_state_rb = input_a(); 
                ...
                if (!(tek3_state_rb & (1 << 6)))   //Кнопки Men "3":
                                                  {
                                                      buf_per=0x90;  //№16-наж.
                                                    do
                                                     tek3_state_rb = input_a(); 
              ...
              //Кнопки Kurs, Izm ,DISP, Sbor,Pam, Serv,4:
               ...
               if (!(tek3_state_rb & (1 << 5)))   //Serv:
                ...
                if (!(tek3_state_rb & (1 << 6)))   //Кнопки Men "4":
                                                  {
                                                      buf_per=0x91;  //№17-наж.
                                                    do
                                                     tek3_state_rb = input_a(); 
              ...
              case 5: //SL5 
                ...
                if (!(tek3_state_rb & (1 << 3)))  //Сброс Установки
                                                   {
                                                     buf_per=0xa3;  //№35-наж.
                                                    do
                                                     tek3_state_rb = input_a(); 
                ...
                if (!(tek3_state_rb & (1 << 6)))  //Кнопки Men "5":
                                                 {
                                                      buf_per=0x92;  //№18-наж.
                                                    do
                                                     tek3_state_rb = input_a(); 
