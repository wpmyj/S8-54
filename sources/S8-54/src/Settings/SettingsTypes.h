...
typedef enum
{
    FunctionPressRShift_SwitchingSpeed,     // Нажатие на ручку переключает скорость - в режиме просмотра памяти - навигации по памяти, в рабочем режиме - скорость вращения ручки смещения
