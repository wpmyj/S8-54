...
/// \brief Возращает адрес первой и последней точки в координатах экрана. Если forCalcualte == true, то берутся значения с начала массива (это нужно для индикации в поточечном режиме
