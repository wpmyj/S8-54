...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
static const   Choice cMode;                    ///< СИНХР - Режим
       void  OnChanged_TrigMode(bool active);   
static const   Choice cSource;                  ///< СИНХР - Источник
static void  OnChanged_Source(bool active);
static const   Choice cPolarity;                ///< СИНХР - Полярность
static void  OnChanged_Polarity(bool active);   
static const   Choice cInput;                   ///< СИНХР - Вход
static void  OnChanged_Input(bool active);
static const    Page ppSearch;                  ///< СИНХР - ПОИСК
static const   Choice cSearch_Mode;             ///< СИНХР - ПОИСК - Режим
static const   Button bSearch_Search;           ///< СИНХР - ПОИСК - Найти
