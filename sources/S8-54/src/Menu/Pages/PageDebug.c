...
static const     Choice mcConsole_Registers_ShowAll;            ///< Œ“À¿ƒ ¿ -  ŒÕ—ŒÀ‹ - –≈√»—“–€ - œÓÍ‡Á˚‚‡Ú¸ ‚ÒÂ
static const     Choice mcConsole_Registers_RD_FL;              ///< Œ“À¿ƒ ¿ -  ŒÕ—ŒÀ‹ - –≈√»—“–€ - RD_FL
static bool      IsActive_Console_Registers(void);
static const     Choice mcConsole_Registers_RShiftA;            ///< Œ“À¿ƒ ¿ -  ŒÕ—ŒÀ‹ - –≈√»—“–€ - U ÒÏ. 1Í
static const     Choice mcConsole_Registers_RShiftB;            ///< Œ“À¿ƒ ¿ -  ŒÕ—ŒÀ‹ - –≈√»—“–€ - U ÒÏ. 2Í
static const     Choice mcConsole_Registers_TrigLev;            ///< Œ“À¿ƒ ¿ -  ŒÕ—ŒÀ‹ - –≈√»—“–€ - U ÒËÌı.
static const     Choice mcConsole_Registers_RangeA;             ///< Œ“À¿ƒ ¿ -  ŒÕ—ŒÀ‹ - –≈√»—“–€ - ¬ŒÀ‹“/ƒ≈À 1
static const     Choice mcConsole_Registers_RangeB;             ///< Œ“À¿ƒ ¿ -  ŒÕ—ŒÀ‹ - –≈√»—“–€ - ¬ŒÀ‹“/ƒ≈À 2
static const     Choice mcConsole_Registers_TrigParam;          ///< Œ“À¿ƒ ¿ -  ŒÕ—ŒÀ‹ - –≈√»—“–€ - œ‡‡Ï. ÒËÌı.
static const     Choice mcConsole_Registers_ChanParamA;         ///< Œ“À¿ƒ ¿ -  ŒÕ—ŒÀ‹ - –≈√»—“–€ - œ‡‡Ï. Í‡Ì. 2
static const     Choice mcConsole_Registers_ChanParamB;         ///< Œ“À¿ƒ ¿ -  ŒÕ—ŒÀ‹ - –≈√»—“–€ - œ‡‡Ï. Í‡Ì. 2
static const     Choice mcConsole_Registers_TBase;              ///< Œ“À¿ƒ ¿ -  ŒÕ—ŒÀ‹ - –≈√»—“–€ - ¬–≈Ãﬂ/ƒ≈À
static const     Choice mcConsole_Registers_TShift;             ///< Œ“À¿ƒ ¿ -  ŒÕ—ŒÀ‹ - –≈√»—“–€ - “ ÒÏ.
...
static const SmallButton bSettings_Exit;                        ///< Œ“À¿ƒ ¿ - Õ¿—“–Œ… » - ¬˚ıÓ‰
...
static const SmallButton bSerialNumber_Exit;                    ///< Œ“À¿ƒ ¿ - —/Õ - ¬˚ıÓ‰
static void       OnPress_SerialNumber_Exit(void);
static const SmallButton bSerialNumber_Change;                  ///< Œ“À¿ƒ ¿ - —/Õ - œÂÂÈÚË
static void       OnPress_SerialNumber_Change(void);
static void          Draw_SerialNumber_Change(int, int);
static const SmallButton bSerialNumber_Save;                    ///< Œ“À¿ƒ ¿ - —/Õ - —Óı‡ÌËÚ¸
...
static const Page pppConsole_Registers =
{
    ...
    {
        (void*)&mcConsole_Registers_ShowAll,      // Œ“À¿ƒ ¿ -  ŒÕ—ŒÀ‹ - –≈√»—“–€ - œÓÍ‡Á˚‚‡Ú¸ ‚ÒÂ
        (void*)&mcConsole_Registers_RD_FL,        // Œ“À¿ƒ ¿ -  ŒÕ—ŒÀ‹ - –≈√»—“–€ - RD_FL
        (void*)&mcConsole_Registers_RShiftA,      // Œ“À¿ƒ ¿ -  ŒÕ—ŒÀ‹ - –≈√»—“–€ - U ÒÏ. 1Í
        (void*)&mcConsole_Registers_RShiftB,      // Œ“À¿ƒ ¿ -  ŒÕ—ŒÀ‹ - –≈√»—“–€ - U ÒÏ. 2Í
        (void*)&mcConsole_Registers_TrigLev,      // Œ“À¿ƒ ¿ -  ŒÕ—ŒÀ‹ - –≈√»—“–€ - U ÒËÌı
        (void*)&mcConsole_Registers_RangeA,       // Œ“À¿ƒ ¿ -  ŒÕ—ŒÀ‹ - –≈√»—“–€ - ¬ŒÀ‹“/ƒ≈À 1
        (void*)&mcConsole_Registers_RangeB,       // Œ“À¿ƒ ¿ -  ŒÕ—ŒÀ‹ - –≈√»—“–€ - ¬ŒÀ‹“/ƒ≈À 2
        (void*)&mcConsole_Registers_TrigParam,    // Œ“À¿ƒ ¿ -  ŒÕ—ŒÀ‹ - –≈√»—“–€ - œ‡‡Ï. ÒËÌı.
        (void*)&mcConsole_Registers_ChanParamA,   // Œ“À¿ƒ ¿ -  ŒÕ—ŒÀ‹ - –≈√»—“–€ - œ‡‡Ï. Í‡Ì. 1
        (void*)&mcConsole_Registers_ChanParamB,   // Œ“À¿ƒ ¿ -  ŒÕ—ŒÀ‹ - –≈√»—“–€ - œ‡‡Ï. Í‡Ì. 2
        (void*)&mcConsole_Registers_TBase,        // Œ“À¿ƒ ¿ -  ŒÕ—ŒÀ‹ - –≈√»—“–€ - ¬–≈Ãﬂ/ƒ≈À
        (void*)&mcConsole_Registers_TShift        // Œ“À¿ƒ ¿ -  ŒÕ—ŒÀ‹ - –≈√»—“–€ - “ ÒÏ.
    }
};
...
#define DRAW_FORMAT2(str, val1, val2)   Painter_DrawFormatText(x0, Y_AND_INCREASE, str, val1, val2);
    ...
    const char *s[3] = {"‚˚ÍÎ˛˜ÂÌÓ", "Ì‡ÒÚÓÂÌÓ ‡‚ÚÓÏ‡ÚË˜ÂÒÍË", "Á‡‰‡ÌÓ ‚Û˜ÌÛ˛"};
...
static void OnPress_SaveFirmware(void)
{
    Display_FuncOnWaitStart("—Óı‡Ìˇ˛ ÔÓ¯Ë‚ÍÛ", "Save the firmware");
