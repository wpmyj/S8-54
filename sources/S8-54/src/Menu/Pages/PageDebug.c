...
static const SmallButton bSerialNumber_Delete;                  ///< ÎÒËÀÄÊÀ - Ñ/Í - Óäàëèòü
static void       OnPress_SerialNumber_Delete(void);
static void          Draw_SerialNumber_Delete(int, int);
static const SmallButton bSerialNumber_Backspace;               ///< ÎÒËÀÄÊÀ - Ñ/Í - Backspace
static void       OnPress_SerialNumber_Backspace(void);
static void          Draw_SerialNumber_Backspace(int, int);     
static const SmallButton bSerialNumber_Insert;                  ///< ÎÒËÀÄÊÀ - Ñ/Í - Âñòàâèòü
...
#define LENGTH_SN 15
static char stringSN[LENGTH_SN] = "";   ///< Ñåðèéíûé íîìåð äëÿ çàïèñè â OTP.
...
static const Page ppSerialNumber =
{
    ...
    Page_SB_SerialNumber,
    {
        ...
        (void*)&bSerialNumber_Delete,   // ÎÒËÀÄÊÀ - Ñ/Í - Óäàëèòü 
        (void*)&bSerialNumber_Backspace,// ÎÒËÀÄÊÀ - Ñ/Í - Backspace
        (void*)&bSerialNumber_Insert,   // ÎÒËÀÄÊÀ - Ñ/Í - Âñòàâèòü
        (void*)0,
