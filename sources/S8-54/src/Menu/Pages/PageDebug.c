...
static const     Choice mcConsole_Registers_ShowAll;            ///< ОТЛАДКА - КОНСОЛЬ - РЕГИСТРЫ - Показывать все
static const     Choice mcConsole_Registers_RD_FL;              ///< ОТЛАДКА - КОНСОЛЬ - РЕГИСТРЫ - RD_FL
static bool      IsActive_Console_Registers(void);
static const     Choice mcConsole_Registers_RShiftA;            ///< ОТЛАДКА - КОНСОЛЬ - РЕГИСТРЫ - U см. 1к
static const     Choice mcConsole_Registers_RShiftB;            ///< ОТЛАДКА - КОНСОЛЬ - РЕГИСТРЫ - U см. 2к
static const     Choice mcConsole_Registers_TrigLev;            ///< ОТЛАДКА - КОНСОЛЬ - РЕГИСТРЫ - U синхр.
static const     Choice mcConsole_Registers_RangeA;             ///< ОТЛАДКА - КОНСОЛЬ - РЕГИСТРЫ - ВОЛЬТ/ДЕЛ 1
static const     Choice mcConsole_Registers_RangeB;             ///< ОТЛАДКА - КОНСОЛЬ - РЕГИСТРЫ - ВОЛЬТ/ДЕЛ 2
static const     Choice mcConsole_Registers_TrigParam;          ///< ОТЛАДКА - КОНСОЛЬ - РЕГИСТРЫ - Парам. синхр.
static const     Choice mcConsole_Registers_ChanParamA;         ///< ОТЛАДКА - КОНСОЛЬ - РЕГИСТРЫ - Парам. кан. 2
static const     Choice mcConsole_Registers_ChanParamB;         ///< ОТЛАДКА - КОНСОЛЬ - РЕГИСТРЫ - Парам. кан. 2
static const     Choice mcConsole_Registers_TBase;              ///< ОТЛАДКА - КОНСОЛЬ - РЕГИСТРЫ - ВРЕМЯ/ДЕЛ
static const     Choice mcConsole_Registers_TShift;             ///< ОТЛАДКА - КОНСОЛЬ - РЕГИСТРЫ - Т см.
