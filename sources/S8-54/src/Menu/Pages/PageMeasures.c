...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
static const       Page ppFreqMeter;                    ///< ИЗМЕРЕНИЯ - ЧАСТОТОМЕР
static const      Choice cFreqMeter_Enable;             ///< ИЗМЕРЕНИЯ - ЧАСТОТОМЕР - Частотомер
static void     OnChanged_FreqMeter_Enable(bool param);
static const      Choice cFreqMeter_TimeF;              ///< ИЗМЕРЕНИЯ - ЧАСТОТОМЕР - Время счёта F
static const      Choice cFreqMeter_FreqClc;            ///< ИЗМЕРЕНИЯ - ЧАСТОТОМЕР - Метки времени
static const      Choice cFreqMeter_NumPeriods;         ///< ИЗМЕРЕНИЯ - ЧАСТОТОМЕР - Кол-во периодов
static const      Choice cIsShow;                       ///< ИЗМЕРЕНИЯ - Показывать
static const      Choice cNumber;                       ///< ИЗМЕРЕНИЯ - Количество
static bool      IsActive_Number(void);
static const      Choice cChannels;                     ///< ИЗМЕРЕНИЯ - Каналы
static bool      IsActive_Channels(void);
static const       Page ppTune;                         ///< ИЗМЕРЕНИЯ - НАСТРОИТЬ
static bool      IsActive_Tune(void);
static void      OnRegSet_Tune(int angle);
static const SmallButton bTune_Exit;                    ///< ИЗМЕРЕНИЯ - НАСТРОИТЬ - Выход
static void       OnPress_Tune_Exit(void);
static const SmallButton bTune_Markers;                 ///< ИЗМЕРЕНИЯ - НАСТРОИТЬ - Маркеры
static void       OnPress_Tune_Markers(void);
static void          Draw_Tune_Markers(int x, int y);
static const SmallButton bTune_Settings;                ///< ИЗМЕРЕНИЯ - НАСТРОИТЬ - Настройка
static void       OnPress_Tune_Settings(void);
static void     Draw_Tune_Settings(int x, int y);
static const      Choice cMode;                         ///< ИЗМЕРЕНИЯ - Вид
