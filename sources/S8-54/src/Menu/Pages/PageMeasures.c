...
static const SButton bTune_Exit;                    ///< ИЗМЕРЕНИЯ - НАСТРОИТЬ - Выход
static void       OnPress_Tune_Exit(void);
static const SButton bTune_Markers;                 ///< ИЗМЕРЕНИЯ - НАСТРОИТЬ - Маркеры
static void       OnPress_Tune_Markers(void);
static void          Draw_Tune_Markers(int x, int y);
static const SButton bTune_Settings;                ///< ИЗМЕРЕНИЯ - НАСТРОИТЬ - Настройка
