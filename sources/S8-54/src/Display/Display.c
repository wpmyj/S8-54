...
//------------------------------------------------------------------------------------------------------------------------------------------------------
void DrawSpectrumChannel(float *spectrum, Color color)
{
...
//------------------------------------------------------------------------------------------------------------------------------------------------------
void DrawCursorRShift(Channel ch)
{
...
//------------------------------------------------------------------------------------------------------------------------------------------------------
void WriteTextVoltage(Channel ch, int x, int y)
{
...
//------------------------------------------------------------------------------------------------------------------------------------------------------
static void Display_ShowWarn(const char *message)
{
    if (warnings[0] == 0)
    {
