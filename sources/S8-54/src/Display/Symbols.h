...
#define SYMBOL_MEMORY_MASK_DELETE       '\x22'  /* ВНЕШН ЗУ-МАСКА-УДАЛИТЬ */

#define SYMBOL_MEMORY_SET_NAME_DELETE   '\x22'  /* ВНЕШН ЗУ-ИМЯ-УДАЛИТЬ */
#define SYMBOL_MEMORY_SET_NAME_INSERT   '\x26'  /* ВНЕШН ЗУ-ИМЯ-ВСТАВИТЬ */
