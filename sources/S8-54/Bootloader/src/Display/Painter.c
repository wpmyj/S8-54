...
{
    StateTransmit_Free,
    StateTransmit_NeedForTransmitFirst,  // Ёто когда нужно передать первый кадр - передаютс€ шрифты
    StateTransmit_NeedForTransmitSecond, // Ёто когда нужно передать второй и последующий кадры - шрифты не передаютс€
