...
//////////////////////////////////////////////////////////
void CopyFont(void *pFont,BYTE *dest,UINT16 _num)
{
    UINT16 i;
    GFX_FONT_SPACE BYTE *src;
    src = (GFX_FONT_SPACE BYTE *)((FONT_FLASH *)pFont)->address;
...
WORD __attribute__((weak)) MyOutCharRender(XCHAR ch, OUTCHAR_PARAM *pParam)
{
    BYTE        temp = 0;
    BYTE        mask;
    BYTE        restoremask;
...
WORD __attribute__((weak)) OutChar(XCHAR ch)
{
    ...
    return (MyOutCharRender(ch, &OutCharParam));
}
...
//MMMMMMYYYYYYYYYYYFFFUUUUUUUNNNNNNNNCCCCTTTTIIIIIIIIIOIONNNNNNN
...
/*WORD __attribute__((weak)) vOutCharRender(XCHAR ch, OUTCHAR_PARAM *pParam)
{
    BYTE        temp = 0;
    BYTE        mask;
    BYTE        restoremask;
    ...
    else
    {
        ...
        bgcolor = vGetPixel(GetX(), GetY() + (currentFont.fontHeader.height >> 1));
